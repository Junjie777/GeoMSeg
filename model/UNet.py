...
class MyNet(nn.Module):
    def __init__(self,
        ...
        self.up4 = Up(base_c * 2, num_classes, bilinear)
...
def run():
    ...
    model = MyNet(bilinear=False).to(device)
    ...
    cv2.imwrite("seg_img/07_UNet_noSE_5/seg_%s_%ds.png" % (args.input_image_path[6:-4], time1), show)
